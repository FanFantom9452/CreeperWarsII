...
scoreboard objectives add final.mined_gold minecraft.mined:minecraft.gold_ore "挖掘金礦數"
scoreboard objectives add final.mined_emerald minecraft.mined:minecraft.emerald_ore "挖掘綠寶石礦數"
