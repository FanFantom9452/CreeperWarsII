...
execute if score @s command_timer matches 131 as @a[distance=..10,gamemode=!spectator] run damage @s 5 mob_attack_no_aggro by @e[type=ravager,tag=boss,sort=nearest,limit=1]
