...
execute if score t particle_worker matches ..30 run function cp2:type/work/maho/warning_circle/red_3
execute if score t particle_worker matches 31 as @a[gamemode=adventure,distance=..3] run function cp2:type/work/maho/warning_circle/in_danger_range
